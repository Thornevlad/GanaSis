                    ...
                    <div class="row">
                       <div class="col-lg-12">
                              <h1>Modulo Usuarios</h1>
                                <button type="button" class="btn btn-primary mt-3 mb-3" data-toggle="modal" data-target="#conusu" data-whatever="@mdo">Consultar Usuario</button>
                                <button type="button" class="btn btn-primary mt-3 mb-3" data-toggle="modal" data-target="#lisusu" data-whatever="@mdo">Listar Usuarios</button>
                                    <!-- Inicio Tabla -->
                                    ...
                                    <table class="table table-bordered">
                                      <thead>
                                        <tr>
                                          ...
                                          <th scope="col">Est_Despacho</th>
                                          <th scope="col">Observacion</th>
                                          <th scope="col">Fecha_Despacho</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>otto.lopez</td>
                                          <td>Despachado</td>
                                          <td>Se envio por Cordinadora</td>
                                          <td>30/12/2020</td>
                                        </tr>
                                      </tbody>
                                    </table>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Consulta de Usuarios</h5>
                            ...
                            <div class="modal-body">
                              <form method="POST" action="infdespsede.php">
                                <div class="form-group">
                                  <input type="text" name ="desusu" placeholder="Ingrese Nombre Usuario" class="form-control" id="">
                                </div>
                                <div class="form-group">
                                <input type="text" name ="deside" placeholder="Ingrese Identificacion de Usuario" class="form-control" id="">
                                </div>
                                <div class="form-group">
                                <input type="text" name ="dessede" placeholder="Ingrese sede de Usuario" class="form-control" id="">
                                </div>
